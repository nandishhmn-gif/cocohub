...
const Home = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Export Ready",
      // changed to avoid claiming international quality standards
      description:
        "Packaging and support available for orders beyond the local market",
    },
    {
  ...
  // Updated stats for a new-market brand — honest but optimistic
  const stats = [
    { number: "100+", label: "Local Customers" },
    { number: "1", label: "State Served" },
    { number: "Growing", label: "Expanding Reach" },
    { number: "Est. 2025", label: "New & Rising" },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              We deliver premium quality coconut products with a commitment to
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              From agriculture to nutrition, we provide comprehensive coconut
              solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                We provide premium coconut products and export services across
                Kartaka & Tamilnadu, with special focus.
              </p>

              <div className="grid grid-cols-2 gap-4 mb-8">
                {["Karnataka", "Tamil Nadu"].map((location, index) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="p-6 text-center bg-white/80">
                ...
                <p className="text-muted-foreground text-sm">
                  Trusted by farms, hotels, and industries
                </p>
              </Card>
              <Card className="p-6 text-center bg-white/80">
      ...
      <section className="py-20 hero-gradient">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Get premium coconut products delivered to your location. Contact us
            for bulk orders, export solutions, and custom requirements.
          </p>
