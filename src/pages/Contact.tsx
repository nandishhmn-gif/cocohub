        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-playfair font-bold mb-6">
              Get Your Coconut
              <br />
              Products Quote Today
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto">
              Ready to partner with India's leading coconut exporter? Contact us
              for premium products, competitive pricing, and reliable delivery
              worldwide.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-8 text-lg">
                Fill out the form below and our export team will provide you
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="fresh-coconuts">
                            Fresh Coconuts
                          </SelectItem>
                          <SelectItem value="coco-power">
                            Coco Power Products
                          </SelectItem>
                          <SelectItem value="bulk-trading">
                            Bulk Trading
                          </SelectItem>
                ...
                <CardContent>
                  ...
                  <div className="mt-4 p-3 bg-coconut-green/10 rounded-md">
                    <p className="text-sm text-coconut-green font-medium">
                      🌍 Export inquiries are handled 24/7 via WhatsApp and
                      email
                    </p>
                  </div>
                </CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Quick answers to common questions about our coconut products and
              services
            </p>
          </div>
            ...
            {[
              {
                ...
                answer:
                  "Our MOQ varies by product: Cocopeat (5 kg), Fresh Coconuts (10 pieces), and Coco Powder products (1 kg). For bulk buyers, we offer flexible order sizes.",
              },
              {
                question: "How long does delivery take?",
                answer:
                  "For most orders within Karnataka and Tamil Nadu, delivery takes 1–7 days depending on quantity and location.",
              },
              {
                question: "Do you provide any documentation?",
                answer:
                  "Yes, we provide GST invoices and basic product quality details for all orders. Additional certificates can be arranged for large bulk orders.",
              },
              {
                question: "Can you provide product samples?",
                answer:
                  "Yes! We provide small samples for serious buyers so you can test the quality before placing a bulk order.",
              },
              {
                question: "What payment methods do you accept?",
                answer:
                  "We accept bank transfers, UPI, and other secure digital payment options. For regular clients, we also offer flexible terms.",
              },
              {
                question: "Do you offer custom packaging?",
                answer:
                  "Yes, we provide labeling and packaging customization for bulk buyers to match their brand or retail needs.",
              },
            ].map((faq, index) => (
      ...
      <section className="py-20 hero-gradient">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            For urgent export inquiries or time-sensitive orders, contact our
            emergency response team available 24/7.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/916363784290?text=Hello%20Cocohub!%20I%20need%20urgent%20assistance%20with%20coconut%20products."
              target="_blank"
